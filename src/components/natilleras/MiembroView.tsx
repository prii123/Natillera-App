        ...
        {loadingBalance ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="p-4 rounded-xl border bg-blue-50 border-blue-400">
              ...
              <div className="text-2xl font-bold text-blue-900">{formatCurrency(Math.round(Number(balance.efectivo)))}</div>
            ...
            <div className="p-4 rounded-xl border bg-yellow-50 border-yellow-400">
              ...
              <div className="text-2xl font-bold text-yellow-900">{formatCurrency(Math.round(Number(balance.prestamos)))}</div>
            ...
            <div className="p-4 rounded-xl border bg-green-50 border-green-400">
              ...
              <div className="text-2xl font-bold text-green-900">{formatCurrency(Math.round(Number(balance.ingresos)))}</div>
            ...
            <div className="p-4 rounded-xl border bg-red-50 border-red-400">
              ...
              <div className="text-2xl font-bold text-red-900">{formatCurrency(Math.round(Number(balance.gastos)))}</div>
            ...
            <div className="p-4 rounded-xl border bg-violet-50 border-violet-400">
              ...
              <div className="text-2xl font-bold text-violet-900">{formatCurrency(Math.round(Number(balance.capital_disponible)))}</div>
